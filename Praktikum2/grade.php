...
<html>
   <head>
      ...
      <title>Ferdian Cahya Sukma</title>
   </head>
   <body>
      <div class="container">
         <div class="row justify-content-md-center">
            <div class="col-sm-6">
               <div class="card">
                  <center>
                     <h5 class="card-header bg-primary text-white">Praktek Pemrograman Web</h5>
                  </center>
			    ...
			    $grade = "F";
                  ...
                  <div class="text-center card-footer text-muted">
                     <a class="text-danger" href="https://fkenn.me/">Ferdi Kennedy
                  </div>
               </div>
            </div>
         </div>
